...
namespace _02_LampShadeQuery.Contracts.Query
{
    public class ProductQuery : IProductQuery
    {
        ...
        public ProductQueryModel GetProductDetails(string slug)
        {
            ...
            var product = _shopContext.Products
               ...
               // .Include(x => x.Comments)
                .Select(product => new ProductQueryModel
                {
                 ...
                 // commentQueryModels = MapComments(product.Comments)
                    // IsInStock = product.
            ...
            product.commentQueryModels = _commentContext.Comments
        ...
        public List<CartItem> CheckInventoryStatus(List<CartItem> cartItems)
        {
            ...
            foreach (var cartItem in cartItems.Where(
                         cartitem=>inventory.Any(x=>x.ProductId==cartitem.Id && x.InStuck)))
            {
